...
import { HOA_DOCUMENT_NAMES, FINANCIAL_DOCUMENT_NAMES, MINUTES_DOCUMENT_NAMES } from "@/lib/documents";

// A fixed allowlist instead of trusting the URL param directly, since
// this becomes a storage path.
const KNOWN_DOCUMENTS = new Set([...HOA_DOCUMENT_NAMES, ...FINANCIAL_DOCUMENT_NAMES, ...MINUTES_DOCUMENT_NAMES]);
